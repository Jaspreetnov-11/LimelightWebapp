...
const FAQ = [
  ...
  { topic: 'Performance score', keys: ['score kaise', 'points kaise', 'marks kaise', 'performance kaise', 'rank kaise', 'top 5', 'top performer', 'leaderboard', 'scoring'],
    a: 'Score 100 ka hai: 50 software se (delivered tasks ke points: creative kaam jaise Shoot/Edit/Design ×1.5, deadline pe ×1.5, allocated hours ke andar bonus; mahine ke best scorer ko 50) aur 50 admin marks. Top 5 dashboard pe sabko dikhte hain. Har mahine fresh.' },
  { topic: 'Productive hours', keys: ['productive', 'productive hours', 'task time', 'kitna kaam kiya'],
    a: 'Productive hours = tasks pe laga time (accept se complete tak) minus breaks. Clock hours alag hain. Dashboard pe dono dikhte hain. Task ke bina kaam ho raha ho to Self Task bana lo, warna wo time productive mein nahi ginega.' },
