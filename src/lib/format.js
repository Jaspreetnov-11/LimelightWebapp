...
export const STATUSES = ['pipeline', 'progress', 'approval', 'completed', 'hold'];
export const STATUS_LABEL = { pipeline: 'In Pipeline', progress: 'In Progress', approval: 'Pending Approval', completed: 'Completed', hold: 'On Hold' };
export const STATUS_CHIP = { completed: 'gr', progress: 'or', pipeline: 'bl', approval: 'pu', hold: 'gy' };
export const STATUS_COLOR = { completed: '#4ADE95', progress: '#FFB84D', pipeline: '#6FA8FF', approval: '#B48CFF', hold: '#6A6A74' };
...
export const TASK_TYPES = ['Other', 'Shoot', 'Edit', 'Design', 'Content', 'Personal'];
