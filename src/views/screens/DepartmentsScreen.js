  ...
  const body = () => {
    ...
    return (<>
      ...
      <div className="dept-charts">
        <div className="panel"><div className="panel-h">Attendance today</div><div className="panel-b" style={{ display: 'flex', justifyContent: 'flex-start', paddingLeft: 10 }}><Donut parts={[['#4ADE95', attPct], ['#2A2A30', 100 - attPct]]} center={attPct + '%|Present'} size={110} /></div></div>
