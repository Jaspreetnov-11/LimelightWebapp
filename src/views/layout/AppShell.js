...
export const NAV = [
  ...
  ['clients', 'Clients', 'brief', 'admin'], ['reports', 'Reports', 'chart', 'admin'], ['notifications', 'Notifications', 'bell', 'all'], ['events', 'Events', 'leaf', 'all'], ['files', 'Files', 'folder', 'all'], ['settings', 'Settings', 'dots', 'all']
];
